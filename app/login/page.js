...
import { Rocket, Mail, Lock, Eye, EyeOff, ArrowRight, Chrome, Sparkles } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex">
      {/* Left panel — branding */}
      <div className="hidden lg:flex flex-col justify-between w-[480px] flex-shrink-0 p-12 relative overflow-hidden border-r border-white/[0.06]">
        {/* BG glow */}
        ...
        <div className="w-full max-w-sm">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="mb-7">
                ...
                <p className="text-sm text-gray-500">
                  {tab === "login"
                    ...
                    : "Create your free account and build your first roadmap."}
                </p>
              </div>

              {/* Google button */}
              <button className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl border border-white/[0.10] bg-white/[0.04] hover:bg-white/[0.08] text-white text-sm font-semibold transition-all hover:scale-[1.02] mb-5">
              ...
              {/* Submit button */}
              <button className="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-sm transition-all hover:scale-[1.02] shadow-xl shadow-indigo-600/25 mb-5">
